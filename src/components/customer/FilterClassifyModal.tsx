...
export default function FilterClassifyModal(
    {
        visible,
        setVisible,
        setStatusValue,
        statusValue,
    }: InferProps<typeof FilterClassifyModal.propTypes>) {
    ...
    const handleSaveValue = () => {
        setStatusValue(
            LIST_CLASSIFY_CUSTOMER_STATUS_FILTER.find(
        ...
        >
            <View style={styles.content}>
                <View style={styles.header}>
                    <Text style={[fs_14_700, text_red, text_center]}>LOẠI KHÁCH HÀNG</Text>
                    <Pressable
                        hitSlop={10}
                        onPress={() => {
                            setVisible(false);
                ...
                <View style={styles.row_container}>
                        {LIST_CLASSIFY_CUSTOMER_STATUS_FILTER.map((item: any, index) => (
                            <View
                                key={index}
                                style={[
                                    styles.row,
