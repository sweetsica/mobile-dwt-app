...
import {LIST_CUSTOMER_TYPE_FILTER} from "../../assets/constant.ts";


export default function FilterCustomerTypeModal(
    {
        visible,
        setVisible,
        setStatusValue,
        statusValue,
    }: InferProps<typeof FilterCustomerTypeModal.propTypes>) {
    ...
    const handleSaveValue = () => {
        setStatusValue(
            LIST_CUSTOMER_TYPE_FILTER.find(
        ...
        <ReactNativeModal
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    <Text style={[fs_14_700, text_red, text_center]}>NHÓM KHÁCH HÀNG</Text>
                    <Pressable
                        hitSlop={10}
                        onPress={() => {
                            setVisible(false);
                ...
                <View
                    ...
                    <FlatList
                        data={LIST_CUSTOMER_TYPE_FILTER}
                        renderItem={({item}) => {
                            return (
                                <PrimaryCheckbox
                                    label={item.label}
...
FilterCustomerTypeModal.propTypes = {
