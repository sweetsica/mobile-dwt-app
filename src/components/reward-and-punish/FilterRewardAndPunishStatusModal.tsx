...
import {LIST_REWARD_AND_PUNISHMENT_STATUS, LIST_REWARD_AND_PUNISHMENT_STATUS_COLOR} from "../../assets/constant.ts";

export default function FilterRewardAndPunishStatusModal(
    {
        visible,
        setVisible,
        setStatusValue,
        statusValue,
    }: InferProps<typeof FilterRewardAndPunishStatusModal.propTypes>) {
    ...
    const handleSaveValue = () => {
        setStatusValue(
            LIST_REWARD_AND_PUNISHMENT_STATUS.find(item => item.value === currentFilter),
        );
        setVisible(false);
    };
    return (
        <ReactNativeModal
            ...
            <View style={styles.content}>
                ...
                <View style={styles.row_container}>
                    {LIST_REWARD_AND_PUNISHMENT_STATUS.map((item: any, index) => (
                        <View
                            key={index}
                            style={[
                                styles.row,
                                ...
                                {
                                    backgroundColor: LIST_REWARD_AND_PUNISHMENT_STATUS_COLOR[item.value],
                                },
                            ]}>
                            <PrimaryCheckbox
                                label={item.label}
...
FilterRewardAndPunishStatusModal.propTypes = {
